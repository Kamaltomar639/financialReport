...
function notification_message(message, type) {

    notifications = function () {
        return {
            init: function () {
                notifications.initNoty();
            },
            initNoty: function () {
                noty({
                    text: message,
...
function ajax_confirmation_method(Id, message, title, classname) {
...
function ajax_confirmation_method2(Id1, Id2, message, title, classname) {
